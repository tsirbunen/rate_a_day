...
const Language _$en = const Language._('EN');
const Language _$fi = const Language._('FI');

Language _$languageValueOf(String name) {
  switch (name) {
    case 'EN':
      return _$en;
    case 'FI':
...
final BuiltSet<Language> _$languageValues =
    new BuiltSet<Language>(const <Language>[
  _$en,
  _$fi,
]);
...
class _$LanguageSerializer implements PrimitiveSerializer<Language> {
  ...
  Language deserialize(Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      Language.valueOf(serialized as String);
}
